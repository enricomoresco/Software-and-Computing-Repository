...
def test_eta_H(z,H, nx, ny):
    ...
    for i in range (0,nx):
        for j in range (0,ny):
            ...
            assert diff  > 0, "ERROR : h+eta < 0, non-physical solution, try higher values of z"
...
def imput(nx,ny,H,nx_u_top,nx_v_top,nx_u_bot,nx_v_bot,nx_eta,ny_u_top,ny_v_top,ny_u_bot,ny_v_bot,ny_eta,uw,vw,u,v,z)  :
